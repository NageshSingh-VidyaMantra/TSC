(() => {
  ...
  // In other words, if you use || to provide some default value to another variable foo,
  // You may encounter unexpected behaviors if you consider some falsy values as usable (e.g., '' or 0)
  // The nullish coalescing operator has the fifth-lowest operator precedence,
  // directly lower than || and directly higher than the conditional (ternary) operator.
